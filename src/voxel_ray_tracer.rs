...
impl Config {
    // The defaults the dimos VoxelRayMapper python binding uses; raycast_accumulate
    // only overrides voxel_size and max_range.
    pub fn with_defaults(voxel_size: f32, max_range: f32) -> Self {
        Config {
            voxel_size,
            max_range,
            ray_subsample: 1,
